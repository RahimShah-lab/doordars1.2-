    ...
    <h1 className="md:w-[35%] mx-auto text-2xl md:text-3xl text-white px-4 md:p-10 relative z-10">
        Artificial Intelligence in Education DoorDars
                    ...
                    {[
                        {
                            ...
                            description:
                                "Discover how cutting-edge AI techniques transform classrooms into interactive and personalized learning environments.",
                            image: "/assets/images/an-educational-illustration-showcasing-open-source-ai-tools-in-action-within-a-school-environment.avif",
                        },
                        {
                            ...
                            image: "/assets/images/=an-illustration-showing-children-of-diverse-backgrounds-learning-with-ai-technology-in-a-classroom-setting.avif",
                        },
                        {
            ...
            <div className="py-16 bg-[#f1f1f1]" data-aos="fade-up">
                ...
                <img
                    src="/assets/images/ai-landing.avif"
                    alt="AI Launchpad"
